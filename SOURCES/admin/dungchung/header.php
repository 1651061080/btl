			...
			<div class="container">
				...
				<div class="nav-collapse collapse">
					<ul class="nav">
						...
						<li class="mn-item" item-id="1"><a href="../../INDEX.PHP"><IMG   src="../../include/dungchung/IMG/logo1.png" width="150PX" height="150PX"></a>
						</li>
						<li class="mn-item" item-id="2"><a href="../../index.php">LUYỆN TẬP</a></li>
						<li class="mn-item" item-id="3"><a href="../../index.php">HỌC BÀI</a></li>
					...
					<div class="nav dropdown1 visible-desktop" style="margin-top: 2px;margin-left: 60px;">
						...
						<div class="dropdown-content">
							<a href="../../dangkythe/dangkythe.php">Đăng ký mua thẻ</a>
