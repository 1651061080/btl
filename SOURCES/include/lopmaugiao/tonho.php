...
<div id="question" style="font-size: 22px"  name="question">
        ...
        $stt=1;
        $sql= "select cauhoi.id,cauhoi.cauhoi,phuongan.a,phuongan.b from cauhoi,phuongan where (cauhoi.id=phuongan.id and cauhoi.chude='tonho')   ORDER BY RAND() LIMIT 1";
