...
<div id="question" style="font-size: 22px"  name="question">
        ...
        $stt=1;
        $sql= "select cauhoi.id,cauhoi.cauhoi,phuongann.a,phuongann.b from cauhoi,phuongann where (cauhoi.id=phuongann.id and cauhoi.chude='dem')   ORDER BY RAND() LIMIT 1";
